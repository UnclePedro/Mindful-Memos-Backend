...
const corsOptions = { origin: ["http://localhost:5173"] }; // Define CORS options, restricting access to your server from only this specific origin
...
app.get("/randomQuote", (req, res) => {
  ...
  const quotesArray = [
    ...
    {
      quote:
        "I was in the Maybach gripping the stem. Snipped the banjo string.",
    },
    {
      quote:
    ...
    {
      quote:
        "My bitch look like Timothy Chalamet. I'm a product of the gutter.",
    },
    {
      quote:
    ...
    {
      quote:
        "Ring so heavy I can't answer the phone. I don't want to kill them.",
    },
    {
      quote:
        "Shut up. I don't want to kill anybody. Put the gun down young man.",
    },
    {
      quote:
    ...
    {
      quote:
        "Motherfucker these are not ruru rumin's. These are chrome hearts.",
    },
    {
    ...
    {
      quote:
        "This motherfucker sounded like a Beyblade. Ah the worms are back.",
    },
    {
    ...
    {
      quote:
        "I want to watch you burn. Ah I remember when I took my first perk.",
    },
    {
  ...
  // Send the random quote as a JSON response to the client
